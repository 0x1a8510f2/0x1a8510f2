...
I'm 0x1a8510f2 (read: [Dave](https://matrix.to/#/!tgDWJZIiwNLhwJzccm:matrix.org/$8ex3Kfta_gtnLGIiiefg-v_HryRe-BzK_NbsTQFyu-k?via=l1qu1d.net&via=mozilla.org&via=geraghty.london)). This profile contains a range of my work, mostly completed for fun with my community hat on (I sometimes wear other hats; my favourite is grey), which means that much of my work is freely available under a variety of open-source licenses. Feel free to look around, or read on for a summary of what I've been up to.
...
- [**Syphon**](https://syphon.org) - A Matrix client with emphasis on privacy and security as well as ease of use. This isn't my own project, but I can sometimes be found hanging around in the Syphon support channels, contributing translations and code, or helping out with the community.
...
- https://dev.l1qu1d.net/0x1a8510f2 | [ My profile on a non-GH git host, which sometimes contains work of mine that isn't available on GH ]
- [`@0x/:l1qu1d.net`](https://matrix.to/#/@0x/:l1qu1d.net) | [ My Matrix account where I can be contacted ]

<br/>

<div align="center">
  <hr width="30%" />
  <img width="2.5%" src="footer.gif" />
  <img width="2.5%" src="footer.gif" />
  <img width="2.5%" src="footer.gif" />
</div>
